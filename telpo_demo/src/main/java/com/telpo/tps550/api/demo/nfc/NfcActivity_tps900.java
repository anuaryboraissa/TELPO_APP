    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				} else if (v.getId() == R.id.nfc_check_btn) {
					if (!isChecking) {
				...
				} else if (v.getId() == R.id.getAtsBtn) {
					getAtsData();
				} else if (v.getId() == R.id.getUidBtn) {
					getUidData();
				} else if (v.getId() == R.id.buttonNfcAPDU) {
					sendAPDUData();
				} else if (v.getId() == R.id.authenticateBtn) {
					m1CardAuthenticate();
				} else if (v.getId() == R.id.writeBlockBtn) {
					writeBlockData();
				} else if (v.getId() == R.id.readBlockBtn) {
					readBlockData();
				} else if (v.getId() == R.id.writeValueBtn) {
					writeValueData();
				} else if (v.getId() == R.id.readValueBtn) {
					readValueData();
				} else if (v.getId() == R.id.transferBtn) {
					transferData();
				} else if (v.getId() == R.id.restoreBtn) {
					restoreData();
				} else if (v.getId() == R.id.incBtn) {
					m1IncOperation();
				} else if (v.getId() == R.id.decBtn) {
					m1DecOperation();
				} else if (v.getId() == R.id.haltBtn) {
					m1HaltOperation();
				} else if (v.getId() == R.id.removeBtn) {
					m1RemoveOperation();
				} else if (v.getId() == R.id.nfc_close_btn) {
					isChecking = false;
					if (readThread != null) {
