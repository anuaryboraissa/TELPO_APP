...
//                        String str = bytesToHexString(buf, bufLen);
    ...
    class ButtonListen implements View.OnClickListener {
        public void onClick(View v) {
            if (v.getId() == R.id.Button_Felica_OpenNFC) {
            ...
            } else if (v.getId() == R.id.Button_Felica_Polling) {
            ...
            } else if (v.getId() == R.id.Button_Felica_Read) {
            ...
            } else if (v.getId() == R.id.Button_Felica_Write) {
            ...
            } else if (v.getId() == R.id.Button_Felica_CloseNFC) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Message message = new Message();
