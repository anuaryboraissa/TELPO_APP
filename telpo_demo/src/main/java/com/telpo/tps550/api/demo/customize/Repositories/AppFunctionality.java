...
//            new MyItem("Money Box Test","Connect and test the money box functionality, ensuring the terminal can trigger and interact with external cash drawers", AppConstants.money_box,15),
            new MyItem("ID Card,IC Card Test"," Validate the terminal’s ability to read data from ID cards,IC cards (chip cards), including testing card recognition and data extraction.", AppConstants.id_card,16),
